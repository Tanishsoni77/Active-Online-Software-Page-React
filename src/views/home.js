          ...
          <div className="home-pills-container">
            <div className="home-pills">
              <div className="home-container6">
                <YouTube></YouTube>
                <YouTube pastedImage_src="/logos/group%201012-200h.png"></YouTube>
                <YouTube pastedImage_src="/logos/layer1-200h.png"></YouTube>
                <YouTube pastedImage_src="/logos/group-200h.png"></YouTube>
              </div>
              <div className="home-container7">
                <YouTube pastedImage_src="/logos/pinterest%20logo-200h.png"></YouTube>
                <YouTube pastedImage_src="/logos/group%201014-200h.png"></YouTube>
                <YouTube pastedImage_src="/logos/group%201015-200h.png"></YouTube>
                <YouTube pastedImage_src="/logos/group%201017-200h.png"></YouTube>
              </div>
            </div>
          </div>
        </div>
